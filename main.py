...
def play_game():
    ...
    while(True):
        ...
        if keyboard.read_key() == "a":
             start_x,start_y,x,y =  move_left(array, start_x, start_y, x, y, start_num)
        elif keyboard.read_key() == "s":
             start_x,start_y,x,y =  move_backwards(array, start_x, start_y, x, y, start_num)
        elif keyboard.read_key() == "w":
             start_x,start_y,x,y =  move_forward(array, start_x, start_y, x, y, start_num)
        elif keyboard.read_key() == "d":
             start_x,start_y,x,y =  move_right(array, start_x, start_y, x, y, start_num)
